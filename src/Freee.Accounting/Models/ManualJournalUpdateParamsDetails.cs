...
namespace Freee.Accounting.Models
{
    ...
    public partial class ManualJournalUpdateParamsDetails : IEquatable<ManualJournalUpdateParamsDetails>
    {
        ...
        protected ManualJournalUpdateParamsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalUpdateParamsDetails" /> class.
        /// </summary>
        ...
        /// <param name="id">貸借行ID: 既存貸借行を更新または削除する場合に指定します。IDを指定しない貸借行は、新規行として扱われ追加されます。.</param>
        ...
        public ManualJournalUpdateParamsDetails(int accountItemId = default(int), long amount = default(long), string description = default(string), EntrySideEnum entrySide = default(EntrySideEnum), long id = default(long), int itemId = default(int), string partnerCode = default(string), int partnerId = default(int), int sectionId = default(int), long segment1TagId = default(long), long segment2TagId = default(long), long segment3TagId = default(long), List<int> tagIds = default(List<int>), int taxCode = default(int), int vat = default(int))
        {
        ...
        {
            return this.Equals(input as ManualJournalUpdateParamsDetails);
        }

        /// <summary>
        /// Returns true if ManualJournalUpdateParamsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualJournalUpdateParamsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualJournalUpdateParamsDetails input)
        {
            if (input == null)
                return false;
