...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "manualJournalCreateParams_details")]
    public partial class ManualJournalCreateParamsDetails : IEquatable<ManualJournalCreateParamsDetails>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalCreateParamsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManualJournalCreateParamsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalCreateParamsDetails" /> class.
        /// </summary>
        ...
        public ManualJournalCreateParamsDetails(int accountItemId = default(int), long amount = default(long), string description = default(string), EntrySideEnum entrySide = default(EntrySideEnum), int itemId = default(int), string partnerCode = default(string), int partnerId = default(int), int sectionId = default(int), long segment1TagId = default(long), long segment2TagId = default(long), long segment3TagId = default(long), List<int> tagIds = default(List<int>), int taxCode = default(int), int vat = default(int))
        {
        ...
        {
            return this.Equals(input as ManualJournalCreateParamsDetails);
        }

        /// <summary>
        /// Returns true if ManualJournalCreateParamsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualJournalCreateParamsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualJournalCreateParamsDetails input)
        {
            if (input == null)
                return false;
